...
const FAQDescription = ({question, answer }) => {
  return (
    <Flex direction="column" textColor="tripl-new.black">
      <Text fontSize="25px"  fontWeight="bold" textAlign="justify">{question}</Text>
      <Text fontSize="20px"  textAlign="justify">{answer}</Text>
    </Flex>
  );
};
...
const Faq = () => {
    ...
    <Flex
      ...
      gap="50px"
    >
    <Text fontSize="50px" fontWeight="bold" color="tripl-new.orange">Frequently Asked Question (FAQ)</Text>
      <FAQDescription
